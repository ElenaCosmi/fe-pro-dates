...
function formatTime(date) {
  ...
  (date.getHours() < 10) ? formattedHours = `0${date.getHours()}` : formattedHours = date.getHours();
  (date.getMinutes() < 10) ? formattedMin = `0${date.getMinutes()}` : formattedMin = date.getMinutes();
